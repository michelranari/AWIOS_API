define({ "api": [
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<p>id of the answer to delete</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "description": "<p>create an answer with tag if it has and return the answer created.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  },
  {
    ...
    "description": "<p>sort all propositions by ascending or descending date and tags if it contains. Exemple of url : localhost:3001/propositions/sort/desc?tag=internet&amp;tag1=soiree</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
